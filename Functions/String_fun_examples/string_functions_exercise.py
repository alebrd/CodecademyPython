...
for clean in highlighted_poems_list:
    highlighted_poems_stripped.append(clean.strip())
...
for clean in highlighted_poems_stripped:
    highlighted_poems_details.append(clean.split(':'))
